...
router.get("/", function (req, res, next) {
  ...
  // Validate page là số nguyên dương
  ...
  // Validate limit là số nguyên dương
  ...
  // Validate maxPrice không được nhỏ hơn minPrice
...
router.post("/", function (req, res, next) {
  ...
  let priceValue = parseFloat(req.body.price);
  if (isNaN(priceValue)) {
    return res.status(400).send({
